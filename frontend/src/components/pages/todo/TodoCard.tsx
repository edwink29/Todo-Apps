...
export function TodoCard({ item, onDelete, onEdit }: TodoCardProps) {
  ...
  return (
    <div className="relative bg-slate-50 hover:bg-slate-100/80 p-3.5 rounded-lg border border-slate-200 flex items-start justify-between gap-2 transition shadow-xs">
